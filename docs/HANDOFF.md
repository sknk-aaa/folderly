...
- Latest source version: `1.6.7.0` (app display `1.6.7`).
- Next Store candidate: `_out\Folderly_1.6.7.0_x64_store.msix`.
...
- Review prompt is now shown on the 2nd successful apply, 3 seconds after the Explorer reopen flow instead of blocking before the user can see the applied icon.
