...
- Latest source version: `1.6.8.0` (app display `1.6.8`).
- Next Store candidate: `_out\Folderly_1.6.8.0_x64_store.msix`.
...
- Review prompt is now shown on the 2nd successful apply, 5 seconds after the Explorer reopen flow instead of blocking before the user can see the applied icon.
