...
internal static partial class NativeMethods
{
    ...
    internal const uint FCSM_ICONFILE       = 0x00000010;
    internal const uint FCS_FORCEWRITE      = 0x00000002;
    ...
    internal struct SHFOLDERCUSTOMSETTINGS
    {
        ...
        internal nint pvid;
        internal nint pszWebViewTemplate;
        internal uint cchWebViewTemplate;
        internal nint pszWebViewTemplateVersion;
        internal nint pszInfoTip;
        internal uint cchInfoTip;
        internal nint pclsid;
        internal uint dwFlags;
        internal nint pszIconFile;
        internal uint cchIconFile;
        internal int iIconIndex;
        internal nint pszLogo;
        internal uint cchLogo;
    }
    ...
    internal static extern int SHGetSetFolderCustomSettings(
        ref SHFOLDERCUSTOMSETTINGS settings,
        string folderPath,
        uint readWrite);
