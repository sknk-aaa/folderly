...
- Current Store package version: `1.3.0.0`（アプリ表示 `1.3.0`）
- Current Store candidate: `_out\Folderly_1.3.0.0_x64_store.msix`
...
- Microsoft Store は4桁目が非ゼロの MSIX を拒否する。`1.3.0.0` は OK、`1.0.0.17` は NG。
